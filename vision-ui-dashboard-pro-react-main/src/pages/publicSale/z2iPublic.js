...
import PriceCard from "cards/PricingCardZ2I";
...
function Z2IPUBLIC() {
  ...
  const contractByToken = async (egoldAmount) => {
    console.log('Time to buy', egoldAmount);
  ...
  return (    
    <Main name="">  
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} lg={4}>
          <PriceCard contractByToken={contractByToken} />
        </Grid>
        <Grid item xs={12} lg={4}>
