...
var Trim = function Trim(_ref) {
  ...
  var trimRef = React.useRef(document.createElement("span"));
  var hiddenTextRef = React.useRef(document.createElement("span"));
  ...
  }, text), overflow ? React.createElement(React.Fragment, null, React.createElement("span", {
    className: "left"
  }, React.createElement("span", {
    className: className
  }, String(text).substring(0, Math.floor(text.length / 2)))), React.createElement("span", {
    className: "ellipsis " + className
  }, "..."), React.createElement("span", {
    className: "right"
  }, React.createElement("span", {
    className: className
  }, String(text).substring(Math.ceil(text.length / 2))))) : React.createElement("span", {
    className: className
  }, text));
};
